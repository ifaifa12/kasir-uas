                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  IconButton(
                                    icon: Icon(Icons.edit_rounded, color: Theme.of(context).brightness == Brightness.dark ? Colors.white : const Color(0xFF4C51BF), size: 22),
                          ...
                          if (!isTercapai)
                            ...
                            Container(
                              ...
                              child: const Center(
                                child: Row(
                                  mainAxisAlignment: Main => _showCatatTabunganDialog(context, target),
                                  children: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.edit_rounded, color: isDark ? Colors.white : const Color(0xFF4C51BF), size: 22),
            onPressed: () async {
